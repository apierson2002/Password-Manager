...
editCredentialView::editCredentialView() // addCredentialView::addCredentialView(passMang::CredentialList&
                                      
{
    CredentialForm(); 
    addButton->hide();
    editButton->clicked().connect(this, &editCredentialView::editNewCredential);
}
